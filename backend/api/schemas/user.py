...
class UserPreferencesUpdate(BaseModel):
    ...
    preferred_categories: Optional[List[str]] = Field(None, description="List of preferred category names")
    ...
    style_preferences: Optional[Dict[str, Any]] = Field(None, description="Style preference metadata")
...
class UserStatsResponse(BaseModel):
    ...
    favorite_categories: List[Dict[str, Any]] = Field(..., description="Top categories by interaction")
    favorite_brands: List[Dict[str, Any]] = Field(..., description="Top brands by interaction")
    avg_price_point: Optional[float] = Field(None, description="Average price of interacted products")
